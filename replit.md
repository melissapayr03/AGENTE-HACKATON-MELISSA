...
- `index_tercero.html` / `tercero.css`: Vehicle detail dashboard styled as a standalone unit view, with simulated diagnostics, interactive Chart.js charts, and manual recalculation controls.
